...
if($url_no == ''){
    $mysql = $pdo->prepare('INSERT INTO `tb_url` (grp_no, url_title, url_addr, url_fg) VALUES ( ?, ?, ?, ?) ');
    ...
    $mysql = $pdo->prepare('UPDATE `tb_url` SET grp_no = ?, url_title = ?, url_addr = ?, url_fg = ? where url_no = ? ');
